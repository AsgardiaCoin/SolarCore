                                          ...
                                          cachedNodeid(-1)
{
    ...
    ui->wallet_path->setText(QString::fromStdString(GetDataDir().string() + QDir::separator().toLatin1() + GetArg("-wallet", "solar.dat")));
#else
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Solar RPC console.") + "<br>" +
