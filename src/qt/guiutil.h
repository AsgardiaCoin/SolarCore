...
/** Utility functions used by the Solar Qt UI.
 */
namespace GUIUtil
{
...
// Render Solar addresses in monospace font
...
// Parse "Solar:" URI into recipient object, return true on successful parsing
