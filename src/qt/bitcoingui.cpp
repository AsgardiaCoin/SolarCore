                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Solar Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Solar address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Solar: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Solar Core"), this);
    aboutAction->setStatusTip(tr("Show information about Solar Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Solar"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Solar addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Solar addresses"));
    ...
    openAction->setStatusTip(tr("Open a Solar: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Solar Core help message to get a list with possible Solar command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Solar Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Solar network", "", count));
}
...
{
    QString strTitle = tr("Solar Core"); // default title
