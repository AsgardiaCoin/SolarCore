/* src/config/Solar-config.h.  Generated from Solar-config.h.in by configure.  */
/* src/config/Solar-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.asgardiacoin.space"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Solar Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Solar Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Solar"
