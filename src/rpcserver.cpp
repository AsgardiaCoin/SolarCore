...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Solar features */
        {"Solar", "masternode", &masternode, true, true, false},
        {"Solar", "listmasternodes", &listmasternodes, true, true, false},
        {"Solar", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Solar", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Solar", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Solar", "masternodedebug", &masternodedebug, true, true, false},
        {"Solar", "startmasternode", &startmasternode, true, true, false},
        {"Solar", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Solar", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Solar", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Solar", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Solar", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Solar", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Solar", "mnbudget", &mnbudget, true, true, false},
        {"Solar", "preparebudget", &preparebudget, true, true, false},
        {"Solar", "submitbudget", &submitbudget, true, true, false},
        {"Solar", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Solar", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Solar", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Solar", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Solar", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Solar", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Solar", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Solar", "checkbudgets", &checkbudgets, true, true, false},
        {"Solar", "mnsync", &mnsync, true, true, false},
        {"Solar", "spork", &spork, true, true, false},
        {"Solar", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Solar", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Solard, or the -server option to Solar-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Solar-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:48434/\n";
}
