...
This mechanism has been integrated into Bitcore-Node-Solar which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Solar-Project/insight-api-Solar#web-socket-api](https://github.com/Solar-Project/insight-api-Solar#web-socket-api) 
* API: [https://github.com/Solar-Project/insight-api-Solar#swifttx-transactions](https://github.com/Solar-Project/insight-api-Solar#swifttx-transactions) 
...
By default, the Solar Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Solar Core daemon:
