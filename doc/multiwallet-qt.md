...
In order to support loading of multiple wallets in Solar-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Solar.cpp.
...
Changes to Solar.cpp
----------------------
Solar.cpp is the entry point into Solar-qt, and as such, will require some minor modifications to provide hooks for
